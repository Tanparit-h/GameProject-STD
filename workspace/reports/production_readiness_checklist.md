...
The AI Office v2 workflow now runs through Creator, Programmer, and Unity only. Codex creates role-specific patterns, each active role performs self-review, and Codex performs the final code/evidence review after Unity validation.

## Passed Gates

- LangGraph v2 workflow runs end to end with Creator, Programmer, and Unity.
...
- Reviewer gates are mostly deterministic; optional AutoGen reviewer mode can still be enabled for role self-review.
