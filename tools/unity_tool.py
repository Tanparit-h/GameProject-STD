...
def get_programmer_script_target(project: Path, source: Path) -> Path | None:
    script_map = {
        ...
        "InventoryState.cs": project / "Assets" / "Scripts" / "AIPrototype" / "InventoryState.cs",
        "PickupInteractable.cs": project / "Assets" / "Scripts" / "AIPrototype" / "PickupInteractable.cs",
        "QuestMarkerObjective.cs": project / "Assets" / "Scripts" / "AIPrototype" / "QuestMarkerObjective.cs",
        "QuestMarkerTracker.cs": project / "Assets" / "Scripts" / "AIPrototype" / "QuestMarkerTracker.cs",
        "DialoguePromptState.cs": project / "Assets" / "Scripts" / "AIPrototype" / "DialoguePromptState.cs",
        "DialoguePromptInteractable.cs": project / "Assets" / "Scripts" / "AIPrototype" / "DialoguePromptInteractable.cs",
        ...
        "AIInventoryPickupSceneSetup.cs": project / "Assets" / "Scripts" / "AIPrototype" / "Editor" / "AIInventoryPickupSceneSetup.cs",
        "AIInventoryPickupSceneValidator.cs": project / "Assets" / "Scripts" / "AIPrototype" / "Editor" / "AIInventoryPickupSceneValidator.cs",
        "AIQuestMarkerSceneSetup.cs": project / "Assets" / "Scripts" / "AIPrototype" / "Editor" / "AIQuestMarkerSceneSetup.cs",
        "AIQuestMarkerSceneValidator.cs": project / "Assets" / "Scripts" / "AIPrototype" / "Editor" / "AIQuestMarkerSceneValidator.cs",
        "AIDialoguePromptSceneSetup.cs": project / "Assets" / "Scripts" / "AIPrototype" / "Editor" / "AIDialoguePromptSceneSetup.cs",
        "AIDialoguePromptSceneValidator.cs": project / "Assets" / "Scripts" / "AIPrototype" / "Editor" / "AIDialoguePromptSceneValidator.cs",
    }
