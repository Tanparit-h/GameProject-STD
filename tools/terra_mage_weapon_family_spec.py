    ...
    file_contents.update(
        {
            ...
            "TerraMageAimTarget.cs": _read_template("TerraMageAimTarget.cs"),
            "TerraMageDamageable.cs": _read_template("TerraMageDamageable.cs"),
    ...
    return spec_factory(
        ...
        required_snippets={
            ...
            "TerraMagePlayerMechanics.cs": [
                ...
                "RaycastNonAlloc",
                "IsUsableParkourHit",
                "HasForwardParkourInput",
                "HasBackwardParkourInput",
                "MoveTowardLedgeAnchor",
                "ResolvePullRange",
                "ResolveThrowForce",
                "ApplyProjectileTint",
                "ProjectOnPlane",
